		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							...
							if(purchaseVO.getPaymentOption().equals("1")) {%>
								<option value="1" selected="selected">카드 결제</option>
								<option value="2">휴대폰 결제</option>
								<option value="3">무통장 입금</option>
							<%} else if(purchaseVO.getPaymentOption().equals("2")) {%>
								<option value="1">카드 결제</option>
								<option value="2" selected="selected">휴대폰 결제</option>
								<option value="3">무통장 입금</option>
							<%} else {%>
								<option value="1">카드 결제</option>
								<option value="2">휴대폰 결제</option>
								<option value="3" selected="selected">무통장 입금</option>
							<%}
							%> --%>
							
							<option value="0" ${!empty purchase.paymentOption && purchase.paymentOption == "0" ? "selected" : "" }>카드 결제</option>
								<option value="1" ${!empty purchase.paymentOption && purchase.paymentOption == "1" ? "selected" : ""}>휴대폰 결제</option>
								<option value="2" ${!empty purchase.paymentOption && purchase.paymentOption == "2" ? "selected" : ""}>무통장 입금</option>
	...
	<tr>
		...
		<td class="ct_write01">
			<%-- <input 	type="text" name="receiverAddr" class="ct_input_g" style="width: 100px; height: 19px" 
							...
							<input 	type="text" name="divyAddr" class="ct_input_g" style="width: 100px; height: 19px" maxLength="20" value="${purchase.divyAddr }" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<%-- <input 	type="text" name="receiverRequest" 	class="ct_input_g" style="width: 100px; height: 19px" 
							...
							<input 	type="text" name="divyRequest" 	class="ct_input_g" style="width: 100px; height: 19px" maxLength="20" value="${purchase.divyRequest }" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
					<input type="submit" value="수정" style="border:none; background:none; font-weight:normal;"/>
				</td>
